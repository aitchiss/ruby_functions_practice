...
class Functions_Practice < MiniTest::Test
  ...
  def test_volume_of_cube()
    first_volume_result = volume_of_cube(3)
    second_volume_result = volume_of_cube(4)
    assert_equal(27, first_volume_result)
    assert_equal(64, second_volume_result)
  end
  ...
  def test_fahrenheit_to_celsius()
    fahrenheit_result = fahrenheit_to_celsius(22)
    assert_equal(71.6, fahrenheit_result)
